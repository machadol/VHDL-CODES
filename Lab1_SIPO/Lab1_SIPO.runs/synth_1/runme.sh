...
HD_PWD='/home/lucas/Documents/UnB/Disciplinas/ED2/VHDL-CODES/Lab1_SIPO/Lab1_SIPO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg_SIPO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_reg_SIPO.tcl
