...
HD_PWD='/home/lucas/Documents/UnB/Disciplinas/ED2/VHDL-CODES/Teste_5_RAM/Teste_5_RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_top_module.tcl
