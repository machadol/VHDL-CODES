...
HD_PWD='/home/lucas/Documents/UnB/Disciplinas/ED2/VHDL-CODES/Lab1_SIPO/Lab1_SIPO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg_SIPO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_reg_SIPO.tcl -notrace
