...
HD_PWD='/home/lucas/Documents/UnB/Disciplinas/ED2/VHDL-CODES/lab1_PIPO/lab1_PIPO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg_PIPO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_reg_PIPO.tcl -notrace
